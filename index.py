...
class Operaciones:
    ...
    #creamos la funcion del botton 4
    def botton4(self):
        if self.validacion1():
            nombre=str(self.var1.get())
            apellido=str(self.var2.get())
            ...
            self.resultado['text'] = '{} tiene {} vocales y tiene {} consonantes y {}  tienen {} vocales y {} consonantes'.format(nombre,vocal1,consonante1,apellido,vocal2,consonante2)
        else:
            self.resultado['text'] = 'los campos son requeridos'            
